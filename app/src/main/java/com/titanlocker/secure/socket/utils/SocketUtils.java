...
import com.titanlocker.secure.appSelection.AppSelectionActivity;
import com.titanlocker.secure.launcher.AppInfo;
import com.titanlocker.secure.settings.SettingContract;
import com.titanlocker.secure.settings.SettingsActivity;
import com.titanlocker.secure.settingsMenu.SettingsMenuActivity;
import com.titanlocker.secure.socket.SocketSingleton;
import com.titanlocker.secure.socket.interfaces.ChangeSettings;
import com.titanlocker.secure.socket.interfaces.DatabaseStatus;
import com.titanlocker.secure.socket.interfaces.GetApplications;
import com.titanlocker.secure.socket.interfaces.SocketEvents;
...
import static com.titanlocker.secure.socket.SocketSingleton.getSocket;
import static com.titanlocker.secure.socket.utils.utils.getAppsList;
import static com.titanlocker.secure.socket.utils.utils.getAppsWithoutIcons;
import static com.titanlocker.secure.socket.utils.utils.settingsChangeListener;
import static com.titanlocker.secure.socket.utils.utils.suspendedDevice;
import static com.titanlocker.secure.socket.utils.utils.syncDevice;
import static com.titanlocker.secure.socket.utils.utils.unSuspendDevice;
import static com.titanlocker.secure.socket.utils.utils.unSyncDevice;
import static com.titanlocker.secure.socket.utils.utils.unlinkDevcie;
import static com.titanlocker.secure.socket.utils.utils.updateAppsList;
import static com.titanlocker.secure.socket.utils.utils.updatePasswords;
import static com.titanlocker.secure.socket.utils.utils.validateRequest;
import static com.titanlocker.secure.utils.AppConstants.APPS_SETTING_CHANGE;
import static com.titanlocker.secure.utils.AppConstants.DB_STATUS;
import static com.titanlocker.secure.utils.AppConstants.DEVICE_STATUS;
import static com.titanlocker.secure.utils.AppConstants.GET_APPLIED_SETTINGS;
import static com.titanlocker.secure.utils.AppConstants.GET_SYNC_STATUS;
import static com.titanlocker.secure.utils.AppConstants.IS_SYNCED;
import static com.titanlocker.secure.utils.AppConstants.SEND_APPS;
import static com.titanlocker.secure.utils.AppConstants.SETTINGS_APPLIED_STATUS;
