...
public class InstallAppsActivity extends BaseActivity implements View.OnClickListener, InstallAppsAdapter.InstallAppListener {
    ...
    private void checkAppInstalledOrNot(List<com.titanlocker.secure.settings.codeSetting.installApps.List> list) {
        if (list != null && list.size() > 0) {
            for (com.titanlocker.secure.settings.codeSetting.installApps.List app :
                    list) {
    ...
    @Override
    public void onInstallClick(View v, final com.titanlocker.secure.settings.codeSetting.installApps.List app, int position) {
        downloadToDisk(app.getApk(), AppConstants.STAGING_BASE_URL + "/getApk/" + CommonUtils.splitName(app.getApk()));

    }

    @Override
    public void onUnInstallClick(View v, com.titanlocker.secure.settings.codeSetting.installApps.List app, int position) {
