...
import com.titanlocker.secure.mdm.MainActivity;
import com.titanlocker.secure.networkResponseModels.NetworkResponse;
import com.titanlocker.secure.permissions.StepperActivity;
...
import com.titanlocker.secure.socket.interfaces.NetworkListener;
import com.titanlocker.secure.socket.interfaces.RefreshListener;
import com.titanlocker.secure.socket.receiver.NetworkReceiver;
import com.titanlocker.secure.socket.service.SocketService;
import com.titanlocker.secure.updateDB.BlurWorker;
import com.titanlocker.secure.utils.AppConstants;
import com.titanlocker.secure.utils.AppInstallReciever;
...
import static com.titanlocker.secure.launcher.MainActivity.RESULT_ENABLE;
import static com.titanlocker.secure.utils.AppConstants.CHAT_ID;
...
import static com.titanlocker.secure.utils.AppConstants.PGP_EMAIL;
import static com.titanlocker.secure.utils.AppConstants.REQUEST_READ_PHONE_STATE;
import static com.titanlocker.secure.utils.AppConstants.SIM_ID;
import static com.titanlocker.secure.utils.AppConstants.TOUR_STATUS;
import static com.titanlocker.secure.utils.AppConstants.VALUE_EXPIRED;
...
//            }
    ...
    public void onBackPressed() {
        ...
        if (settingsPresenter.isMyLauncherDefault()) {
            Intent home = new Intent(SettingsActivity.this, com.titanlocker.secure.launcher.MainActivity.class);
            startActivity(home);
            finish();
        } else {
            super.onBackPressed();
