...
public class MainModel implements MainContract.MainMvpModel {
     ...
     * @param message this is the message to the broadcast catches when thrown from {@link MainActivity#onCreate(Bundle)} OR {@link com.titanlocker.secure.utils.Utils#sendMessageToActivity(String, Context)}
