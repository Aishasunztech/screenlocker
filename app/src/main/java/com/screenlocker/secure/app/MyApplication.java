...
import com.screenlocker.secure.room.migrations.Migration_15_13;
...
//        }
        ...
        new Thread(() -> myAppDatabase = Room.databaseBuilder(getApplicationContext(), MyAppDatabase.class, AppConstants.DATABASE_NAME)
                .addMigrations(new Migration_11_13(11, 13),
                        new Migration_13_14(13, 14)
                        , new Migration_14_15(14, 15)
                        , new Migration_15_13(15, 13))
                .build()).start();
