                        ...
                        if (isActivity) {
                            if (PrefUtils.getBooleanPref(this, UNINSTALL_ALLOWED)) {
                                ...
                                if (ssPermissions.contains(componentName.flattenToShortString())) {
                                    Timber.d("activity allowed");
                                    AppConstants.TEMP_SETTINGS_ALLOWED = true;
                                } else if ("com.android.settings/.SubSettings".equals(componentName.flattenToShortString())) {
                                    if (previousTasksFor.contains(previous_task)) {
                                        AppConstants.TEMP_SETTINGS_ALLOWED = true;
                                    } else {
                                        checkAppStatus(componentName);
                                    }
                            ...
                            previous_task = componentName.flattenToShortString();
                        }
                    }
                }
...
//        wm.addView(mView, localLayoutParams);
        ...
        previousTasksFor.add("com.secure.launcher/com.screenlocker.secure.settings.AdvanceSettings");
        previousTasksFor.add("com.android.settings/.Settings$ConfigureNotificationSettingsActivity");
        previousTasksFor.add("com.secure.launcher/android.widget.FrameLayout");
