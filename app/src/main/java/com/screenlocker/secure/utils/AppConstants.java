...
//    String STAGING_BASE_URL = "http://10.0.2.2:3000/mobile/";//for localhost emulator
    public static final String STAGING_BASE_URL = "http://192.168.0.114:3000/mobile/";//for localhost real device

    //  SocketUtils constants
//    public static final String SOCKET_SERVER_URL = "http://134.209.124.196:3000";//live
    public static final String SOCKET_SERVER_URL = "http://192.168.0.114:3000";//local host with real device
