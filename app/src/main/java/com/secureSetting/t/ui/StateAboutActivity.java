...
import com.secureSetting.t.util.BitmapUtil;
import com.secureSetting.t.util.SortEnum;
...
public class StateAboutActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            Bitmap bitmap = BitmapUtil.drawableToBitmap(AppUtil.getPackageIcon(StateAboutActivity.this, mPackageName));
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                try {
                    if (networkStatsManager != null) {
                        ...
                        if (ActivityCompat.checkSelfPermission(StateAboutActivity.this, Manifest.permission.READ_PHONE_STATE) == PackageManager.PERMISSION_GRANTED) {
