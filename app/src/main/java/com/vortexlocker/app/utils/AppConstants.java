...
public class AppConstants {
    public static final String LOGO_URL = "http://104.248.244.22:3000/users/getFile/";
...
//    public static String STAGING_BASE_URL = "http://192.168.1.134:3000/mobile/";//for localhost real device

    //  SocketUtils constants
    public static final String SOCKET_SERVER_URL = "http://134.209.124.196:3000";//live
//    public static final String SOCKET_SERVER_URL = "http://192.168.1.134:3000";//local host with real device
