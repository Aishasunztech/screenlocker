...
public class MainModel implements MainContract.MainMvpModel {
     ...
     * @param message this is the message to the broadcast catches when thrown from {@link MainActivity#onCreate(Bundle)} OR {@link com.vortexlocker.app.utils.Utils#sendMessageToActivity(String, Context)}
