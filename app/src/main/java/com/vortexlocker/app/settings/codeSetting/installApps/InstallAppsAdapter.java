...
public class InstallAppsAdapter extends RecyclerView.Adapter<InstallAppsAdapter.MyViewHolder> {
    ...
    public interface InstallAppListener {
        void onInstallClick(View v, com.vortexlocker.app.settings.codeSetting.installApps.List app, int position);

        void onUnInstallClick(View v, com.vortexlocker.app.settings.codeSetting.installApps.List app, int position);
    }

    InstallAppListener mListener;

    public InstallAppsAdapter(List<com.vortexlocker.app.settings.codeSetting.installApps.List> appModelList, InstallAppListener installAppListener) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(com.vortexlocker.app.settings.codeSetting.installApps.List app) {
