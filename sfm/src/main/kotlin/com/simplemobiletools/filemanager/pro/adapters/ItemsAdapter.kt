...
import kotlinx.android.synthetic.main.sfm_item_list_file_dir.view.*
import kotlinx.android.synthetic.main.sfm_item_list_section.view.*
...
class ItemsAdapter(activity: SimpleActivity, var listItems: MutableList<ListItem>, val listener: ItemOperationsListener?, recyclerView: MyRecyclerView,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val layout = if (viewType == TYPE_SECTION) R.layout.sfm_item_list_section else R.layout.sfm_item_list_file_dir
