...
import com.secure.filemanager.BuildConfig
...
fun Activity.sharePaths(paths: ArrayList<String>) {
    sharePathsIntent(paths, packageName)
}
...
fun Activity.openPath(path: String, forceChooser: Boolean, openAsType: Int = OPEN_AS_DEFAULT) {
    openPathIntent(path, forceChooser, packageName, getMimeType(openAsType))
}
