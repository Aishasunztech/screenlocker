...
import kotlinx.android.synthetic.main.sfm_item_manage_favorite.view.*
import java.util.*
...
class ManageFavoritesAdapter(activity: BaseSimpleActivity, var favorites: ArrayList<String>, val listener: RefreshRecyclerViewListener?,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = createViewHolder(R.layout.sfm_item_manage_favorite, parent)
